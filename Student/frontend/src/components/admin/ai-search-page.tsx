...
export function AiSearchPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      >
        <form className="rounded-[24px] bg-[#14293E] p-8 md:p-10 mb-8 shadow-xl panel-hero" onSubmit={handleSearch}>
          {/* Section Label */}
          ...
          <div className="flex w-full items-center gap-3 rounded-full border border-white/10 bg-[#0B1724] px-4 py-3 shadow-inner mb-2">
            ...
            <div className="flex items-center gap-2">
              ...
              <button
                ...
                disabled={loading}
                suppressHydrationWarning
                className="rounded-full bg-[#FFD600] disabled:bg-slate-700 disabled:text-slate-450 disabled:cursor-not-allowed disabled:scale-100 px-6 py-2.5 text-sm font-bold tracking-wide text-[#0A1624] transition hover:bg-[#FCD400]/90 hover:scale-105 active:scale-95 flex items-center justify-center gap-2"
              >
                {loading ? (
                  <>
        ...
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3 w-full">
          {logs.map((entry) => (
            <motion.div
              ...
              className="flex flex-col justify-between p-5 bg-gradient-to-b from-[#14283F]/40 to-[#0A1724]/60 backdrop-blur-md rounded-2xl border border-white/[0.06] hover:border-[#FFD600]/30 hover:shadow-[0_12px_24px_rgba(0,0,0,0.4)] text-left transition-all group w-full cursor-pointer"
            >
