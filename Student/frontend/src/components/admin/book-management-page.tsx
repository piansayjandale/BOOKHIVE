...
export function BookManagementPage() {
  ...
  const [tab, setTab] = useState<"management" | "catalog" | "archived">("management");
    ...
    <div className="space-y-6">
      ...
      <div className="flex gap-4 border-b border-[var(--line)]">
        ...
        <button
          ...
          className={`px-4 py-3 font-semibold text-sm transition-colors ${tab === "archived" ? "border-b-2 border-[var(--accent)] text-[var(--accent)]" : "text-[var(--module-muted-color)] hover:text-[var(--foreground)]"}`}
        >
          Archived Books
        </button>
        <button
                  ...
                  <tr key={book.id} className="border-t border-[var(--line)]">
                    <td className="px-4 py-3">
                      <div className="flex flex-wrap items-center gap-2">
                        ...
                        {book.archived && (
                          <span className="inline-flex items-center rounded-full bg-red-500/15 border border-red-500/30 px-2 py-0.5 text-[10px] font-bold text-red-400 uppercase tracking-wider">
                            Archived
                          </span>
                        )}
                      </div>
      ...
      {tab === "archived" && (
        <AdminSection
          ...
          description="View and restore books that have been removed from active circulation by librarians."
        >
            ...
            <table className="min-w-full text-left">
              ...
              <tbody>
                  ...
                  <tr key={book.id} className="border-t border-[var(--line)]">
                    ...
                    <td className="px-4 py-3">
                      <div className="flex flex-wrap gap-2">
                        <button
                          type="button"
                          className="admin-primary-btn inline-flex items-center gap-2 rounded-xl px-3 py-2 text-sm"
                ...
                {(payload?.books ?? []).length === 0 && (
                  <tr>
                    <td colSpan={6} className="px-4 py-8 text-center text-[var(--module-muted-color)]">
                  ...
                  <tr key={record.id} className="border-t border-[var(--line)]">
                    <td className="px-4 py-3 text-sm font-semibold">
                      <div className="flex flex-wrap items-center gap-2">
                        ...
                        {record.archived && (
                          <span className="inline-flex items-center rounded-full bg-red-500/15 border border-red-500/30 px-2 py-0.5 text-[9px] font-bold text-red-400 uppercase tracking-wider">
                            Archived
                          </span>
                        )}
                      </div>
      ...
      >
        <form className="grid gap-4 md:grid-cols-2" onSubmit={handleSubmit}>
          ...
          <div className="md:col-span-2 flex items-center gap-2 select-none py-1">
            <input
              type="checkbox"
              id="form-archived"
