...
const stopwords = new Set([
  "a", "about", "across", "after", "all", "an", "and", "any", "are", "as", "at", "be",
  "book", "books", "by", "can", "could", "describe", "do", "does", "find", "for", "from",
  "give", "has", "have", "how", "i", "if", "in", "into", "is", "it", "library", "looking",
  "me", "my", "need", "of", "on", "or", "please", "prompt", "recommend", "related", "search",
  "show", "some", "something", "tell", "that", "the", "their", "them", "then", "there", "these",
  "they", "this", "to", "want", "what", "when", "where", "which", "who", "why", "will", "with",
  "would", "you", "your"
]);
...
export function deriveDepartment(text: string) {
  ...
  let winningDepartment: Department = "Circulation";
  let winningScore = 0;
